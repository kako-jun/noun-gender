...
処理:
  ...
  ステップ3: "Lack"をイタリア語の名詞に翻訳
    → it_translation: "manque" (フランス語の場合)
    → it_gender: "m"

正解:
  it_translation: "manque"
  it_gender: "m"

不正解（これらは絶対にダメ）:
  ❌ it_translation: "manque et absence" (複数の意味を含めた)
  ❌ it_translation: "absence" (2番目の意味を使った)
  ❌ it_translation: "le fait de manquer" (説明文にした)
```
...
正解:
  it_translation: "abbaye" (単数形)
  it_gender: "f"

不正解:
  ❌ it_translation: "abbayes" (複数形にした)
  ❌ it_translation: "bâtiment monastique" (説明的にした)
```
...
処理:
  ...
  ステップ2: "Summary"をイタリア語の**名詞**に翻訳
    → ❌ "abstrait" (形容詞)
    → ✅ "résumé" (名詞)

正解:
  it_translation: "résumé" (名詞「要約」)
  it_gender: "m"

不正解:
  ❌ it_translation: "abstrait" (形容詞で翻訳した)
  ❌ it_translation: "résumer" (動詞で翻訳した)
```
...
正解:
  it_translation: "capacité" (名詞1語)
  it_gender: "f"

不正解:
  ❌ it_translation: "possession de moyens" (説明的すぎる)
  ❌ it_translation: "pouvoir" (動詞的な意味)
```
...
4. ✅ **性別チェック**: 性別記号が m (男性名詞: il), f (女性名詞: la) の範囲内か
...
4. ✅ 3文字未満の翻訳: 0件
5. ✅ コミット完了
6. ✅ 進捗ファイル更新: `.claude/workflow/progress-stage3-it.txt`
