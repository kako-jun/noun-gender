...
2. `data/translations_{LANG_CODE}.csv`を読んで、現在の状態を確認する
...
2. 各単語について：
   ...
   - {LANGUAGE_NAME}の名詞形に翻訳
   - 文法的性別を判定
   - 意味の{LANGUAGE_NAME}訳を作成
3. `data/translations_{LANG_CODE}.csv`の該当200行を直接編集（Editツール使用）
4. 次の200語へ進む
